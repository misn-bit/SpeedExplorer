...
public class AppSettings
{
    ...
    public System.Collections.Generic.Dictionary<string, string> Hotkeys { get; set; } = new()
    {
        ...
        { "CloseTab", "Control, W" },
        { "SwitchTab1", "Control, D1" },
        { "SwitchTab2", "Control, D2" },
        { "SwitchTab3", "Control, D3" },
        { "SwitchTab4", "Control, D4" },
        { "SwitchTab5", "Control, D5" },
        { "SwitchTab6", "Control, D6" },
        { "SwitchTab7", "Control, D7" },
        { "SwitchTab8", "Control, D8" },
        { "SwitchTab9", "Control, D9" },
        { "ClearSelection", "Escape" },
        { "OpenSelected", "Enter" },
        { "NavigateUp", "Back" },
        { "ZoomIconsIn", "Control, Oemplus" },
        { "ZoomIconsInNumpad", "Control, Add" },
        { "ZoomIconsOut", "Control, OemMinus" },
        { "ZoomIconsOutNumpad", "Control, Subtract" },
        ...
        { "ImageViewerPrevious", "Left" },
        { "ImageViewerPreviousAlt", "A" },
        { "ImageViewerNext", "Right" },
        { "ImageViewerNextAlt", "D" },
        { "ImageViewerNextSpace", "Space" },
        { "ImageViewerClose", "Escape" },
        { "ImageViewerToggleFullscreen", "F11" },
        { "ImageViewerToggleFullscreenAlt", "F" },
        { "ImageViewerZoomIn", "Add" },
        { "ImageViewerZoomInAlt", "Oemplus" },
        { "ImageViewerZoomOut", "Subtract" },
        { "ImageViewerZoomOutAlt", "OemMinus" },
        { "ImageViewerRotate", "Control, R" },
        { "ImageViewerFitWindow", "Control, D0" },
        { "ImageViewerFitWindowNumpad", "Control, NumPad0" },
        { "ImageViewerFitWindowPlain", "D0" },
        { "ImageViewerFitWindowPlainNumpad", "NumPad0" },
        { "ImageViewerActualSize", "Control, D1" },
        { "ImageViewerActualSizeNumpad", "Control, NumPad1" },
        { "ImageViewerActualSizePlain", "D1" },
        { "ImageViewerActualSizePlainNumpad", "NumPad1" },
        { "ImageViewerFitSmallDimensionControl", "Control, D2" },
        { "ImageViewerFitSmallDimensionControlNumpad", "Control, NumPad2" },
        { "ImageViewerFitSmallDimensionNumpad", "NumPad2" }
    };
